...
cDialog_SusPay::cDialog_SusPay( wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &position, const wxSize& size, long style )
...
void cDialog_SusPay::CreateGUIControls()
{
    ...
    mCancelAfterEnabled = new wxCheckBox( this, ID_MCANCELAFTER, _( "Can Canceled After" ), wxPoint( 16, 16 ), wxSize( 129, 25 ), 0, wxDefaultValidator, _( "mCancelAfterEnabled" ) );
